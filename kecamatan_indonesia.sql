DROP TABLE IF EXISTS `kecamatan_indonesia`;

CREATE TABLE IF NOT EXISTS `kecamatan_indonesia` (
...
LOCK TABLES `kecamatan_indonesia` WRITE;
INSERT INTO `kecamatan_indonesia` VALUES
