DROP TABLE IF EXISTS `detail_negara`;

CREATE TABLE IF NOT EXISTS `detail_negara` (
	`id` int(5) NOT NULL AUTO_INCREMENT,
	`kode_negara` char(2) NOT NULL DEFAULT '',
	`nama_negara` varchar(45) NOT NULL DEFAULT '',
	`nama_mata_uang` char(3) DEFAULT NULL,
	`kode_fips` char(2) DEFAULT NULL,
	`no_iso` char(4) DEFAULT NULL,
	`utara` varchar(30) DEFAULT NULL,
	`selatan` varchar(30) DEFAULT NULL,
	`timur` varchar(30) DEFAULT NULL,
	`barat` varchar(30) DEFAULT NULL,
	`ibu_kota` varchar(30) DEFAULT NULL,
	`nama_benua` varchar(15) DEFAULT NULL,
	`kode_benua` char(2) DEFAULT NULL,
	`bahasa` varchar(100) DEFAULT NULL,
	`iso_alpha_3` char(3) DEFAULT NULL,
	`id_geo` int(10) DEFAULT NULL,
	PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=0 COLLATE=utf8_unicode_ci;

INSERT INTO `detail_negara` (`kode_negara`, `nama_negara`, `nama_mata_uang`, `kode_fips`, `no_iso`, `utara`, `selatan`, `timur`, `barat`, `ibu_kota`, `nama_benua`, `kode_benua`, `bahasa`, `iso_alpha_3`, `id_geo`) VALUES
